...
public interface InventoryRepository extends JpaRepository<Inventory, Long>, JpaSpecificationExecutor<Inventory> {
        ...
        /**
         * Recupera el material en plaza cuyo stock remanente se haya tornado crítico o
         * residualmente
         ...
         * 
         * @return Colecciones de activos extinguiéndose en inventarios de todas las
         *         sedes.
         */
        ...
        /**
         * Encuentra remanentes biológicos y de mercancía vinculados a la dependencia de
         * lotes
         * cuya vigencia expire anterior o estrictamente igual al parámetro temporal
         * suministrado.
         * 
         * @param date Timestamp acotando la pesquisa de lotes o empaquetados
         *             perecibles.
         * @return Desglose de mermas, productos listos a rematar o caducados si son
         *         desfasajes.
         */
        ...
        /**
         * Analiza individualmente los límites predefinidos personalizables definidos
         * según el control operativo
         * devolviéndonos artículos que vulneraron el límite o "Stock Mínimo" estipulado
         * expresamente por el regente.
         * 
         * @return Bienes y medicinas por debajo de su umbral de tolerancia preventivo
         *         en bodega.
         */
